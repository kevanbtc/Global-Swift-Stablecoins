...
export namespace PolicySetEvent {
  export type InputTuple = [
    policyId: BytesLike,
    policy: ComplianceRegistryUpgradeable.PolicyStruct
  ];
  export type OutputTuple = [
    policyId: string,
    policy: ComplianceRegistryUpgradeable.PolicyStructOutput
  ];
  export interface OutputObject {
    policyId: string;
    policy: ComplianceRegistryUpgradeable.PolicyStructOutput;
...
export namespace ProfileSetEvent {
  export type InputTuple = [
    user: AddressLike,
    profile: ComplianceRegistryUpgradeable.ProfileStruct
  ];
  export type OutputTuple = [
    user: string,
    profile: ComplianceRegistryUpgradeable.ProfileStructOutput
  ];
  export interface OutputObject {
    user: string;
    profile: ComplianceRegistryUpgradeable.ProfileStructOutput;
