...
export interface MerkleStreamDistributorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "GOVERNOR_ROLE"
...
export interface MerkleStreamDistributor extends BaseContract {
  connect(runner?: ContractRunner | null): MerkleStreamDistributor;
  waitForDeployment(): Promise<this>;

  interface: MerkleStreamDistributorInterface;
