...
export interface WrappedShares4626Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface WrappedShares4626 extends BaseContract {
  connect(runner?: ContractRunner | null): WrappedShares4626;
  waitForDeployment(): Promise<this>;

  interface: WrappedShares4626Interface;
